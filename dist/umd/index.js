(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react/jsx-runtime'), require('react'), require('resize-observer-polyfill')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react/jsx-runtime', 'react', 'resize-observer-polyfill'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["react-dragger-layout"] = {}, global.jsxRuntime, global.React, global.ResizeObserver));
})(this, (function (exports, jsxRuntime, React, ResizeObserver) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function useWidget(options) {
        ...
        var _a = React__namespace.useState(), widgetRect = _a[0], setWidgetRect = _a[1];
        var clampW = React__namespace.useMemo(function () {
            var _a, _b, _c, _d, _e;
        ...
        var clampH = React__namespace.useMemo(function () {
            var _a, _b, _c, _d, _e;
            if (!widget)
                return 0;
    ...
    var Layout = function (props) {
        ...
        var colWidth = React__namespace.useMemo(function () {
            if (!size || !layoutRef.current)
                return 0;
            return size.width / col;
        }, [col, size]);
        var rowHeight = React__namespace.useMemo(function () {
            if (!propsRowHieght)
                return colWidth;
        ...
        // 布局更新与 Placeholder
        var engineRef = React__namespace.useRef(null);
        var _c = React__namespace.useState(), activeWidgetId = _c[0], setActiveWidgetId = _c[1];
        var _d = React__namespace.useState(), activeWidget = _d[0], setActiveWidget = _d[1];
        ...
        var handleActionStart = React__namespace.useCallback(function (widget, eventType) {
        ...
        var handleActionDoing = React__namespace.useCallback(function (widget, newBoxPos, eventType) {
        ...
        var handleActionEnd = React__namespace.useCallback(function (widget) {
         ...
         */
        var _e = React__namespace.useState([]), clonedChildren = _e[0], setClonedChildren = _e[1];
        React__namespace.useEffect(function () {
            var tempList = [];
            var rowCount = 0;
            React__namespace.Children.toArray(children).forEach(function (child) {
                var curChild = child;
            ...
            var realChildren = tempList.map(function (item) {
                return React__namespace.cloneElement(item.child, {
                    id: item.id,
                    widget: item.widget,
    ...
    var Widget = function (props) {
        ...
        var widgetRef = React__namespace.useRef(null);
        var mouseDownEventRef = React__namespace.useRef(null);
        var actionOffsetRef = React__namespace.useRef(null);
        ...
        //   };
        // }, [layoutData, widget]);
        var actionStartRef = React__namespace.useRef();
        var handleActionStart = React__namespace.useCallback(function (type) {
            if (!widget)
                return;
        ...
        var actionDoingRef = React__namespace.useRef();
        var handleActionDoing = React__namespace.useCallback(function (type, e) {
        ...
        var actionEndRef = React__namespace.useRef();
        var handleActionEnd = React__namespace.useCallback(function (type) {
            if (!widget)
                return;
        ...
        // ===== Draggable ========
        // ========================
        var dragElRef = React__namespace.useRef(null);
        var _a = React__namespace.useState(false), isDragging = _a[0], setIsDragging = _a[1];
        var _b = React__namespace.useState(false), isDragEnding = _b[0], setIsDragEnding = _b[1];
        var dragFollow = React__namespace.useCallback(function (e) {
        ...
        // 鼠标移动
        var dragMouseMove = React__namespace.useCallback(function (e) {
            var _a, _b;
        ...
        // 鼠标抬起
        var dragMouseUp = React__namespace.useCallback(function (e) {
            var _a;
        ...
        // 鼠标按下
        var dragMouseDown = React__namespace.useCallback(function (e) {
        ...
        // 开启拖拽
        var dragEnabledRef = React__namespace.useRef(false);
        var enableDraggable = React__namespace.useCallback(function () {
            var _a;
        ...
        // 关闭拖拽
        var diableDraggable = React__namespace.useCallback(function () {
            if (!dragElRef.current)
                return;
        ...
        // ===== Resizeable =======
        // ========================
        var resizeElRef = React__namespace.useRef(null);
        var _c = React__namespace.useState(false), isResizing = _c[0], setIsResizing = _c[1];
        var _d = React__namespace.useState(false), isResizeEnding = _d[0], setIsResizeEnding = _d[1];
        var resizeFollow = React__namespace.useCallback(function (e) {
        ...
        var resizeMouseMove = React__namespace.useCallback(function (e) {
            var _a, _b;
            var s = mouseDownEventRef.current;
        ...
        // 鼠标抬起
        var resizeMouseUp = React__namespace.useCallback(function (e) {
            var _a;
        ...
        // 鼠标按下
        var resizeMouseDown = React__namespace.useCallback(function (e) {
        ...
        // 开启 resize
        var resizeEnabledRef = React__namespace.useRef(false);
        var enableResizable = React__namespace.useCallback(function () {
        ...
        // 关闭 resize
        var disableResizable = React__namespace.useCallback(function () {
            if (!resizeElRef.current)
                return;
        ...
        return (jsxRuntime.jsxs(Wrapper, __assign({ ref: widgetRef, className: cls({
                dragging: isDragging,
                resizing: isResizing,
    ...
    var BreakLayout = function (props) {
        ...
        var _a = React__namespace.useState(), breakSign = _a[0], setBreakSign = _a[1];
        var breakPointList = React__namespace.useMemo(function () {
            var entries = [];
        ...
        var cols = React__namespace.useMemo(function () {
        ...
        var widgets = React__namespace.useMemo(function () {
            if (!breakSign)
                return [];
        ...
        var handleLayoutResize = React__namespace.useCallback(function (size) {
        ...
        return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(Layout, __assign({}, ret, { col: cols, widgets: widgets, gap: gap, rowHeight: rowHeight, onSizeChange: handleLayoutResize }, { children: children })) }));
    };

    exports.BreakLayout = BreakLayout;
